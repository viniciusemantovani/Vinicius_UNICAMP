...
tf(sos_cheby_t2(1, 1:3), sos_cheby_t2(1, 4:6))
disp('Transfer function second order 2 cheby2:')
tf(sos_cheby_t2(2, 1:3), sos_cheby_t2(2, 4:6))
...
disp('Transfer function second order 1 eliptic:')
tf(sos_eliptic(1, 1:3), sos_eliptic(1, 4:6))
disp('Transfer function second order 2 eliptic:')
tf(sos_eliptic(2, 1:3), sos_eliptic(2, 4:6))
