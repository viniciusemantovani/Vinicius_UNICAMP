//Better Euler Method Code, by: Vinicius Esperanca Mantovani

#include <stdlib.h>
#include <stdio.h>

//Defined values to be used:
#define f(x,y) (y + (h/2)*(2-2*y-2*(h*(1-2*y)+y))) //Define the function wanted here!
...
struct eulerVectors *eA(float X0, float Y0, float h, float n){
...
int main(int argc, char *argv){
    ...
    struct eulerVectors *vectors = eA(X0, Y0, h, n);
